...
/* ── 칸을 정하는 자 ──
   전부 도면 px 기준. 화면 가로는 늘 1440, 한 화면 높이는 680~820 이고 그중 위 170 은
   제목 띠라 벽은 510~650 이다. 세로로 흐르는 벽은 가장 긴 벽을, 가로 줄은 칸이 가장
...
const W = 1440;
const BAND = 170;
const WALL_MAX = 820 - BAND;
const WALL_MIN = 680 - BAND;
const GAP = 16;
