 ...
 *
 * 여덟 장을 45도 간격으로 돌려 놓는다. 가로 반지름 40(도면 폭의 %),
 * 세로 반지름 33(짧은 쪽 화면의 %). 이 크기여야 대각 카드가 글자 띠 바깥으로
 * 나가고, 이웃 카드끼리도 한 축은 반드시 떨어진다. 더 줄이면 겹치기 시작한다.
 * 네 모서리는 분야 카드, 위아래와 좌우는 사진이 온다.
 */
const CFG = [
  { sx: -8, sy: -10, sr: -18, x: 0, y: -33 },
  { sx: 14, sy: -10, sr: 20, x: -28.3, y: -23.3 },
  { sx: -16, sy: 0, sr: -4, x: -40, y: 0 },
  { sx: 1, sy: -10, sr: -2, x: 28.3, y: -23.3 },
  { sx: 18, sy: 1, sr: 6, x: 40, y: 0 },
  { sx: -6, sy: 10, sr: 6, x: -28.3, y: 23.3 },
  { sx: 8, sy: 7, sr: 3, x: 0, y: 33 },
  { sx: 20, sy: 12, sr: -7, x: 28.3, y: 23.3 },
];
