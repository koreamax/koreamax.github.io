...
/* 펼친 자리. x 는 도면 가로의 %, y 는 짧은 쪽 화면의 %.
 *
 * 대각으로 흩뿌리면 카드끼리도, 가운데 글자와도 겹친다. 그래서 자리를 정해 둔다:
 * 왼쪽 세 장 · 오른쪽 세 장 · 위아래 한 장씩. 가운데 세로 띠는 글자 몫으로 비워 둔다.
 * 옆줄은 세로 간격 24 씩(카드 높이 21 보다 크다), 위아래 장은 글자와 붙지 않게 32 로 뺀다.
 */
const CFG = [
  { sx: -8, sy: -10, sr: -18, x: 0, y: -32 },
  { sx: 14, sy: -10, sr: 20, x: -38, y: -24 },
  { sx: -16, sy: 0, sr: -4, x: -38, y: 0 },
  { sx: 1, sy: -10, sr: -2, x: 38, y: -24 },
  { sx: 18, sy: 1, sr: 6, x: 38, y: 0 },
  { sx: -6, sy: 10, sr: 6, x: -38, y: 24 },
  { sx: 8, sy: 7, sr: 3, x: 0, y: 32 },
  { sx: 20, sy: 12, sr: -7, x: 38, y: 24 },
];
